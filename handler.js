        ...
        try {
            ...
            try {
                ...
                if (user) {
                    ...
                    if (!isNumber(user.money)) user.money = 99999999999999999999999999999999999999999999999999999999999999999888889999
                    if (!isNumber(user.bank)) user.bank = 999999999999999
                    if (!isNumber(user.lastclaim)) user.lastclaim = 9999999999999999999999999999999999999999989989898988989898989898898999
