    ...
    async handler(chatUpdate) {
        ...
        try {
            ...
            try {
                ...
                if (user) {
                    if (!isNumber(user.exp)) user.exp = 99999999999999999999999999999999999998888998999999999999999999999999999989898988
                    if (!isNumber(user.limit)) user.limit = 99999
                    if (!isNumber(user.joinlimit)) user.joinlimit = 999
                    if (!isNumber(user.money)) user.money = 999999999999999999999999999999999999999999999999999999999999999998888899999
                    if (!isNumber(user.bank)) user.bank = 999999999999999
                    if (!isNumber(user.lastclaim)) user.lastclaim = 999999999999999999999999999999999999999998998989898898989898989889899999
                    ...
                    if (!isNumber(user.anggur)) user.anggur = 1000
                    if (!isNumber(user.jeruk)) user.jeruk = 1000
                    if (!isNumber(user.mangga)) user.mangga = 1000
                    if (!isNumber(user.apel)) user.apel = 1000
                    if (!isNumber(user.pisang)) user.pisang = 1000
                    if (!isNumber(user.bibitanggur)) user.bibitanggur = 1000
                    if (!isNumber(user.bibitjeruk)) user.bibitjeruk = 1000
                    if (!isNumber(user.bibitmangga)) user.bibitmangga = 1000
                    if (!isNumber(user.bibitapel)) user.bibitapel = 1000
                    if (!isNumber(user.bibitpisang)) user.bibitpisang = 1000
                    if (!isNumber(user.gardenboxs)) user.gardenboxs = 1000
                    ...
                    exp: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    limit: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    joinlimit: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    spammer: 999999999999999999999999999999999999988889989999999999999999999999999999898989880,
                    money: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    bank: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    health: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    tiketcoin: 0,
                    healtmonster: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    armormonster: 0,
                    lastclaim: 0,
                    registered: false,
                    name: m.name,
                    ...
                    pc: 0,
                    expg: 0,
                    level: 99999999999999999999999999999999999998888998999999999999999999999999999989898988,
                    role: 'Hacker',
                    autolevelup: true,
        ...
        //    const groupMetadata = (m.isGroup ? (conn.chats[m.chat].metadata || await conn.groupMetadata(m.chat)): {}) || {}
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (xp > 9999999999999999999999999999) m.reply('Ngecit -_-') // Hehehe
                    else m.exp += xp
